//
//  AppDelegate.swift
//  severalFilesTutorial
//

//  Copyright (c) 2016 Jose Lopez. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate, TVApplicationControllerDelegate {
    ...
    static let tvBaseURL = "http://localhost:9002/"
    static let tvBootURL = "\(AppDelegate.tvBaseURL)/HelloWorldRequestLoading.js"
